...
function getBalance(walletAddress) {
    return __awaiter(this, void 0, void 0, function () {
        var publicKey, balanceLamports, balanceSOL;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [2 /*return*/, "Balance of ".concat(walletAddress, ": ").concat(balanceSOL, " SOL")];
            }
        });
    });
}
server.tool("getBalance", "get balance of a wallet", {
    walletAddress: zod_1.z.string()
}, function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
    var balance;
    var walletAddress = _b.walletAddress;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0: return [4 /*yield*/, getBalance(walletAddress)];
            case 1:
                balance = _c.sent();
                if (!balance) {
                    return [2 /*return*/, {
                            content: [
                                {
                                    type: "text",
                                    text: "Failed to retrieve wallet adress: ".concat(walletAddress),
                                },
                            ],
                        }];
                }
                return [2 /*return*/, {
                        content: [
                            {
                                type: "text",
                                text: "Successfully retrieved the balance of wallet adress: ".concat(walletAddress, "\n                     ").concat(walletAddress, ":{\n                      balance:").concat(balance, "\n                     }   \n    \n                    "),
                            },
                        ],
                    }];
        }
